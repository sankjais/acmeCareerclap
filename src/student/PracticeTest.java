						...
						if (driver.getTitle().contains("CareerClap")) {
							...
							if (driver.getCurrentUrl().equals(student.landingURL)) {
								if (driver.getTitle().contains("CareerClap")) {
									...
									driver.findElement(By.xpath("//div[1]/span")).click();
									Thread.sleep(2000);
									wait.until(ExpectedConditions.urlToBe(student.practiceStartURL));
									if (driver.getCurrentUrl().equals(student.practiceStartURL)) {
										if (driver.getTitle().contains("CareerClap")) {
											...
											wait.until(ExpectedConditions
													.urlContains(student.practiceAssessmentInstructions));
											if (driver.getCurrentUrl().equals(student.practiceAssessmentInstructions)) {
												if (driver.getTitle().contains("CareerClap")) {
													System.out.println(
															"Practice Assessment Instruction page is loaded successfuly");
													Thread.sleep(2000);
													element = driver.findElement(By.xpath("//li[2]/div//a[1]"));
													...
													if (driver.getCurrentUrl().equals(student.practiceQuiz)) {
														...
														if (driver.getCurrentUrl()
															...
															System.out.println(student.firstname
																	+ " have completed Practice Assessment...!");
															Thread.sleep(1000);
															driver.findElement(
